...
-- Дамп структуры базы данных cafe
CREATE DATABASE IF NOT EXISTS `cafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `cafe`;

-- Дамп структуры для таблица cafe.cart_items
...
-- Дамп данных таблицы cafe.cart_items: ~0 rows (приблизительно)

-- Дамп структуры для таблица cafe.client_booking
CREATE TABLE IF NOT EXISTS `client_booking` (
  `id_client_booking` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_client_booking`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `client_booking_ibfk_4` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.client_booking: ~11 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.client_order
CREATE TABLE IF NOT EXISTS `client_order` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `client_order_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.client_order: ~9 rows (приблизительно)
INSERT INTO `client_order` (`id_client_order`, `id_user`, `fio`, `phone`, `mail`, `address`, `dop_info`, `delivery_date`) VALUES
	...
	(26, NULL, 'голубева', '+7 (914) 814-01-24', 'evgen1@gmail.com', 'Биробиджан', 'сейчас', '2023-12-10 13:25:00');

-- Дамп структуры для таблица cafe.comments
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.comments: ~4 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.conditions
...
-- Дамп данных таблицы cafe.conditions: ~3 rows (приблизительно)
INSERT INTO `conditions` (`id_condition`, `name_condition`) VALUES
	(1, 'Ожидают'),
	(2, 'В процессе'),
	(3, 'Готово');

-- Дамп структуры для таблица cafe.con_client_booking
CREATE TABLE IF NOT EXISTS `con_client_booking` (
  `id_booking` int(11) NOT NULL AUTO_INCREMENT,
  `id_client_booking` int(11) NOT NULL,
  `id_user` int(11) DEFAULT NULL,
  `id_condition` int(11) NOT NULL,
  PRIMARY KEY (`id_booking`),
  KEY `id_client_booking` (`id_client_booking`),
  KEY `id_condition` (`id_condition`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `con_client_booking_ibfk_1` FOREIGN KEY (`id_client_booking`) REFERENCES `client_booking` (`id_client_booking`) ON DELETE CASCADE,
  CONSTRAINT `con_client_booking_ibfk_2` FOREIGN KEY (`id_condition`) REFERENCES `conditions` (`id_condition`),
  CONSTRAINT `con_client_booking_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.con_client_booking: ~11 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.con_client_order
CREATE TABLE IF NOT EXISTS `con_client_order` (
  ...
  KEY `id_client` (`id_client_order`),
  KEY `id_product` (`id_product`),
  KEY `id_condition` (`id_condition`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `con_client_order_ibfk_1` FOREIGN KEY (`id_client_order`) REFERENCES `client_order` (`id_client_order`) ON DELETE CASCADE,
  CONSTRAINT `con_client_order_ibfk_2` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`),
  CONSTRAINT `con_client_order_ibfk_3` FOREIGN KEY (`id_condition`) REFERENCES `conditions` (`id_condition`) ON DELETE CASCADE,
  CONSTRAINT `con_client_order_ibfk_4` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.con_client_order: ~14 rows (приблизительно)
INSERT INTO `con_client_order` (`id_order`, `id_client_order`, `id_product`, `id_condition`, `id_user`, `quantity`, `cost`) VALUES
	...
	(43, 25, 42, 1, 1, 2, 798),
	(44, 26, 1, 1, NULL, 1, 399);

-- Дамп структуры для таблица cafe.migration
...
-- Дамп данных таблицы cafe.migration: ~2 rows (приблизительно)
INSERT INTO `migration` (`version`, `apply_time`) VALUES
	('m000000_000000_base', 1704673113),
	('m180604_202836_create_cart_items_table', 1704673121);

-- Дамп структуры для таблица cafe.product
CREATE TABLE IF NOT EXISTS `product` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_product_categories` (`id_product_categories`),
  KEY `id_product_undercategories` (`id_product_undercategories`),
  KEY `id_stock` (`id_stock`),
  CONSTRAINT `product_ibfk_2` FOREIGN KEY (`id_product_categories`) REFERENCES `product_categories` (`id_product_categories`) ON DELETE CASCADE,
  CONSTRAINT `product_ibfk_3` FOREIGN KEY (`id_product_undercategories`) REFERENCES `product_undercategories` (`id_product_undercategories`) ON DELETE CASCADE,
  CONSTRAINT `product_ibfk_5` FOREIGN KEY (`id_stock`) REFERENCES `stocks` (`id_stock`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.product: ~52 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.product_categories
CREATE TABLE IF NOT EXISTS `product_categories` (
  `id_product_categories` int(11) NOT NULL AUTO_INCREMENT,
  `name_product_categories` varchar(255) NOT NULL,
  `imglink` varchar(255) NOT NULL,
  PRIMARY KEY (`id_product_categories`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.product_categories: ~9 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.product_undercategories
CREATE TABLE IF NOT EXISTS `product_undercategories` (
  `id_product_undercategories` int(11) NOT NULL AUTO_INCREMENT,
  `name_product_undercategories` varchar(255) NOT NULL,
  `imglink` text NOT NULL,
  `id_product_categories` int(11) NOT NULL,
  PRIMARY KEY (`id_product_undercategories`),
  KEY `id_product_categories` (`id_product_categories`),
  CONSTRAINT `product_undercategories_ibfk_1` FOREIGN KEY (`id_product_categories`) REFERENCES `product_categories` (`id_product_categories`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;

-- Дамп данных таблицы cafe.product_undercategories: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.stocks
...
-- Дамп данных таблицы cafe.stocks: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица cafe.user
...
-- Дамп данных таблицы cafe.user: ~6 rows (приблизительно)
INSERT INTO `user` (`id`, `login`, `password`, `role`, `auth_key`) VALUES
	...
	(4, 'vika', 'f2c3ec352b8cc4ef13289c3aba603da0', 2, NULL),
	(5, 'evgenia', '1e0fa96aba396be82171311ba4940d6b', 2, NULL),
	(6, 'fa', '230ab20a1b5fc727b355c1e667f4c4fa', 2, NULL),
	(7, 'Tvgenia', '88ca80df2d72dbebcef83a756c323da1', 2, NULL);
